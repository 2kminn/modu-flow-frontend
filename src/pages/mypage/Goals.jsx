  ...
  return (
    <div className="mt-3">
      ...
      <div className="mt-2 h-2 w-full overflow-hidden rounded-full bg-[color:var(--c-surface-2)]">
        <div className="h-full rounded-full bg-[linear-gradient(90deg,var(--c-primary),var(--c-purple))]" style={{ width: `${pct}%` }} />
      </div>
    </div>
  );
}
    ...
    <section className="space-y-4">
      ...
      <Card>
        <div className="flex items-start justify-between gap-3">
          ...
          <span className="rounded-2xl bg-[color:var(--c-primary-soft)] px-3 py-2 text-xs font-extrabold text-[color:var(--c-primary)] transition-[background-color] duration-200">
            알림 ON
          </span>
        </div>
